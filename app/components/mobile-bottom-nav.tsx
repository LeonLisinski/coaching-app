      ...
      >
        <div className="flex items-stretch justify-around h-14">
          {primaryItems.map(({ href, effectiveHref, labelKey, icon: Icon }) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-[10px] font-medium leading-none" style={{ opacity: active ? 1 : 0.65 }}>
          ...
          >
            ...
            <span className="text-[10px] font-medium leading-none" style={{ opacity: isMoreActive ? 1 : 0.65 }}>
              Više
            </span>
          </button>
        </div>
