  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl flex flex-col p-0 gap-0 overflow-hidden max-h-[92vh]" showCloseButton={false}>
        <DialogTitle className="sr-only">Dodaj recept</DialogTitle>
        <DialogDescription className="sr-only">Dodaj recept</DialogDescription>
        ...
        <div className="bg-gradient-to-r from-rose-500 to-pink-400 px-6 py-4 shrink-0 flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <h2 className="text-white font-bold text-base">Dodaj recept</h2>
            <p className="text-rose-100/70 text-xs">Novi recept s popisom namirnica</p>
          </div>
